import{r as u,a as W,j as s,L as k}from"./app-RMPR-2sO.js";import{A as H}from"./ApplicationLogo-Dc5j3bmg.js";let Q={data:""},G=e=>{if(typeof window=="object"){let t=(e?e.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return t.nonce=window.__nonce__,t.parentNode||(e||document.head).appendChild(t),t.firstChild}return e||Q},J=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,X=/\/\*[^]*?\*\/|  +/g,S=/\n+/g,j=(e,t)=>{let r="",i="",n="";for(let o in e){let a=e[o];o[0]=="@"?o[1]=="i"?r=o+" "+a+";":i+=o[1]=="f"?j(a,o):o+"{"+j(a,o[1]=="k"?"":t)+"}":typeof a=="object"?i+=j(a,t?t.replace(/([^,])+/g,l=>o.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,d=>/&/.test(d)?d.replace(/&/g,l):l?l+" "+d:d)):o):a!=null&&(o=/^--/.test(o)?o:o.replace(/[A-Z]/g,"-$&").toLowerCase(),n+=j.p?j.p(o,a):o+":"+a+";")}return r+(t&&n?t+"{"+n+"}":n)+i},v={},V=e=>{if(typeof e=="object"){let t="";for(let r in e)t+=r+V(e[r]);return t}return e},ee=(e,t,r,i,n)=>{let o=V(e),a=v[o]||(v[o]=(d=>{let c=0,m=11;for(;c<d.length;)m=101*m+d.charCodeAt(c++)>>>0;return"go"+m})(o));if(!v[a]){let d=o!==e?e:(c=>{let m,p,h=[{}];for(;m=J.exec(c.replace(X,""));)m[4]?h.shift():m[3]?(p=m[3].replace(S," ").trim(),h.unshift(h[0][p]=h[0][p]||{})):h[0][m[1]]=m[2].replace(S," ").trim();return h[0]})(e);v[a]=j(n?{["@keyframes "+a]:d}:d,r?"":"."+a)}let l=r&&v.g?v.g:null;return r&&(v.g=v[a]),((d,c,m,p)=>{p?c.data=c.data.replace(p,d):c.data.indexOf(d)===-1&&(c.data=m?d+c.data:c.data+d)})(v[a],t,i,l),a},te=(e,t,r)=>e.reduce((i,n,o)=>{let a=t[o];if(a&&a.call){let l=a(r),d=l&&l.props&&l.props.className||/^go/.test(l)&&l;a=d?"."+d:l&&typeof l=="object"?l.props?"":j(l,""):l===!1?"":l}return i+n+(a??"")},"");function E(e){let t=this||{},r=e.call?e(t.p):e;return ee(r.unshift?r.raw?te(r,[].slice.call(arguments,1),t.p):r.reduce((i,n)=>Object.assign(i,n&&n.call?n(t.p):n),{}):r,G(t.target),t.g,t.o,t.k)}let _,P,T;E.bind({g:1});let b=E.bind({k:1});function re(e,t,r,i){j.p=t,_=e,P=r,T=i}function w(e,t){let r=this||{};return function(){let i=arguments;function n(o,a){let l=Object.assign({},o),d=l.className||n.className;r.p=Object.assign({theme:P&&P()},l),r.o=/ *go\d+/.test(d),l.className=E.apply(r,i)+(d?" "+d:"");let c=e;return e[0]&&(c=l.as||e,delete l.as),T&&c[0]&&T(l),_(c,l)}return t?t(n):n}}var se=e=>typeof e=="function",z=(e,t)=>se(e)?e(t):e,ae=(()=>{let e=0;return()=>(++e).toString()})(),U=(()=>{let e;return()=>{if(e===void 0&&typeof window<"u"){let t=matchMedia("(prefers-reduced-motion: reduce)");e=!t||t.matches}return e}})(),oe=20,B="default",F=(e,t)=>{let{toastLimit:r}=e.settings;switch(t.type){case 0:return{...e,toasts:[t.toast,...e.toasts].slice(0,r)};case 1:return{...e,toasts:e.toasts.map(a=>a.id===t.toast.id?{...a,...t.toast}:a)};case 2:let{toast:i}=t;return F(e,{type:e.toasts.find(a=>a.id===i.id)?1:0,toast:i});case 3:let{toastId:n}=t;return{...e,toasts:e.toasts.map(a=>a.id===n||n===void 0?{...a,dismissed:!0,visible:!1}:a)};case 4:return t.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(a=>a.id!==t.toastId)};case 5:return{...e,pausedAt:t.time};case 6:let o=t.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(a=>({...a,pauseDuration:a.pauseDuration+o}))}}},M=[],Y={toasts:[],pausedAt:void 0,settings:{toastLimit:oe}},y={},q=(e,t=B)=>{y[t]=F(y[t]||Y,e),M.forEach(([r,i])=>{r===t&&i(y[t])})},Z=e=>Object.keys(y).forEach(t=>q(e,t)),ie=e=>Object.keys(y).find(t=>y[t].toasts.some(r=>r.id===e)),A=(e=B)=>t=>{q(t,e)},ne={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},le=(e={},t=B)=>{let[r,i]=u.useState(y[t]||Y),n=u.useRef(y[t]);u.useEffect(()=>(n.current!==y[t]&&i(y[t]),M.push([t,i]),()=>{let a=M.findIndex(([l])=>l===t);a>-1&&M.splice(a,1)}),[t]);let o=r.toasts.map(a=>{var l,d,c;return{...e,...e[a.type],...a,removeDelay:a.removeDelay||((l=e[a.type])==null?void 0:l.removeDelay)||e?.removeDelay,duration:a.duration||((d=e[a.type])==null?void 0:d.duration)||e?.duration||ne[a.type],style:{...e.style,...(c=e[a.type])==null?void 0:c.style,...a.style}}});return{...r,toasts:o}},de=(e,t="blank",r)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:t,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...r,id:r?.id||ae()}),N=e=>(t,r)=>{let i=de(t,e,r);return A(i.toasterId||ie(i.id))({type:2,toast:i}),i.id},x=(e,t)=>N("blank")(e,t);x.error=N("error");x.success=N("success");x.loading=N("loading");x.custom=N("custom");x.dismiss=(e,t)=>{let r={type:3,toastId:e};t?A(t)(r):Z(r)};x.dismissAll=e=>x.dismiss(void 0,e);x.remove=(e,t)=>{let r={type:4,toastId:e};t?A(t)(r):Z(r)};x.removeAll=e=>x.remove(void 0,e);x.promise=(e,t,r)=>{let i=x.loading(t.loading,{...r,...r?.loading});return typeof e=="function"&&(e=e()),e.then(n=>{let o=t.success?z(t.success,n):void 0;return o?x.success(o,{id:i,...r,...r?.success}):x.dismiss(i),n}).catch(n=>{let o=t.error?z(t.error,n):void 0;o?x.error(o,{id:i,...r,...r?.error}):x.dismiss(i)}),e};var ce=1e3,ue=(e,t="default")=>{let{toasts:r,pausedAt:i}=le(e,t),n=u.useRef(new Map).current,o=u.useCallback((p,h=ce)=>{if(n.has(p))return;let f=setTimeout(()=>{n.delete(p),a({type:4,toastId:p})},h);n.set(p,f)},[]);u.useEffect(()=>{if(i)return;let p=Date.now(),h=r.map(f=>{if(f.duration===1/0)return;let C=(f.duration||0)+f.pauseDuration-(p-f.createdAt);if(C<0){f.visible&&x.dismiss(f.id);return}return setTimeout(()=>x.dismiss(f.id,t),C)});return()=>{h.forEach(f=>f&&clearTimeout(f))}},[r,i,t]);let a=u.useCallback(A(t),[t]),l=u.useCallback(()=>{a({type:5,time:Date.now()})},[a]),d=u.useCallback((p,h)=>{a({type:1,toast:{id:p,height:h}})},[a]),c=u.useCallback(()=>{i&&a({type:6,time:Date.now()})},[i,a]),m=u.useCallback((p,h)=>{let{reverseOrder:f=!1,gutter:C=8,defaultPosition:R}=h||{},O=r.filter(g=>(g.position||R)===(p.position||R)&&g.height),K=O.findIndex(g=>g.id===p.id),I=O.filter((g,D)=>D<K&&g.visible).length;return O.filter(g=>g.visible).slice(...f?[I+1]:[0,I]).reduce((g,D)=>g+(D.height||0)+C,0)},[r]);return u.useEffect(()=>{r.forEach(p=>{if(p.dismissed)o(p.id,p.removeDelay);else{let h=n.get(p.id);h&&(clearTimeout(h),n.delete(p.id))}})},[r,o]),{toasts:r,handlers:{updateHeight:d,startPause:l,endPause:c,calculateOffset:m}}},pe=b`
from {
...
to {
  ...
  animation: ${ke} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Ce=({toast:e})=>{let{icon:t,type:r,iconTheme:i}=e;return t!==void 0?typeof t=="string"?u.createElement(Ne,null,t):t:r==="blank"?null:u.createElement(we,null,u.createElement(ge,{...i}),r!=="loading"&&u.createElement(je,null,r==="error"?u.createElement(fe,{...i}):u.createElement(be,{...i})))},$e=e=>`
0% {transform: translate3d(0,${e*-200}%,0) scale(.6); opacity:.5;}
100% {transform: translate3d(0,0,0) scale(1); opacity:1;}
`,Le=e=>`
0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}
100% {transform: translate3d(0,${e*-150}%,-1px) scale(.6); opacity:0;}
`,Me="0%{opacity:0;} 100%{opacity:1;}",ze="0%{opacity:1;} 100%{opacity:0;}",Ee=w("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
