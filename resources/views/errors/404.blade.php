...
<body class="bg-gradient-to-br from-primary-50 via-white to-primary-100 min-h-screen flex items-center justify-center px-4">
    <div class="max-w-2xl w-full">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-8 sm:p-12 text-center">
                ...
                <div class="mb-6 animate-float">
                    <div class="inline-flex items-center justify-center w-32 h-32 bg-gradient-to-br from-primary-100 to-primary-200 rounded-full mb-4">
                        <svg class="w-16 h-16 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>
                    <h1 class="text-7xl sm:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-primary-400">
                        404
                    </h1>
                </div>
            ...
            <!-- Decorative Footer -->
            <div class="bg-gradient-to-r from-primary-50 to-primary-100 px-8 py-4 border-t border-primary-200">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-600">
                    ...
                    <a href="mailto:abdulhamidkap@gmail.com" class="text-primary-600 hover:text-primary-700 font-medium hover:underline">
                        Hubungi Tim Support
                    </a>
                </div>
            </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            <p>Error Code: 404 | {{ now()->format('Y-m-d H:i:s') }}</p>
        </div>
    </div>
</body>
</html>
