        ...
        ...(user.role === 'company' ? [
            {
                ...
                active: route().current('company.projects.*') || route().current('company.tasks.*'),
            },
            {
                name: 'My Clients',
            ...
            },
            {
                ...
                active: route().current('company.teams.*'),
            },
            {
                name: 'News',
                href: '/news',
        ...
        ...(user.role === 'client' || user.role === 'klien' ? [
            {
                ...
                active: route().current('klien.projects.*') || route().current('klien.tasks.*'),
            },
            {
                name: 'News',
                href: '/news',
