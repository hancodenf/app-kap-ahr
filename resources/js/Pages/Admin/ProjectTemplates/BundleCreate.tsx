...
export default function Create({ auth }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('admin.project-templates.template-bundles.store'));
    };
    ...
    return (
        ...
        >
            <Head title="Create Template Category" />
                ...
                <div className="mx-auto max-w-2xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <div className="mb-6">
                                <h3 className="text-lg font-medium text-gray-900 mb-2">New Template Category</h3>
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g., Project Audit BLU"
                                        required
                                    />
                                    {errors.name && (
