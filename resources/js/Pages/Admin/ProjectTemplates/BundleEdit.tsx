                                        ...
                                        >
                                            <div className="flex flex-wrap gap-2">
                                                <button 
                                                    ...
                                                    className="bg-green-600 hover:bg-green-700 text-white px-2 md:px-3 py-1 rounded text-xs md:text-sm font-medium transition-colors"
                                                >
                                                    Add Sub Step
                                                </button>
                                                <button 
                                                    onClick={() => handleEditStep(step)}
                                                    className="bg-blue-600 hover:bg-blue-700 text-white px-2 md:px-3 py-1 rounded text-xs md:text-sm font-medium transition-colors"
                                                >
                                                    Edit Step
                                                </button>
                                                <button 
                                                    onClick={() => handleDeleteStep(step.id)}
                                                    className="bg-red-600 hover:bg-red-700 text-white px-2 md:px-3 py-1 rounded text-xs md:text-sm font-medium transition-colors"
                                                >
                                                    Delete Step
                                                </button>
                                            </div>
